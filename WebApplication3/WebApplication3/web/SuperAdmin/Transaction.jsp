...
try{
  ...
  if(searchVal!=null){
      ...
      sql ="select concat(a.firstname,' ',a.lastname) as 'admin', concat(b.firstname,' ',b.lastname) as 'client', c.rental_price,c.name,c.quantity, d.status from transaction d join administrator a on d.admin_id = a.admin_id join client b on d.client_id = b.client_id join product c on d.product_code = c.product_code ORDER BY a.firstname"; 
  }
  int i=0;
  resultSet = statement.executeQuery(sql);
