...
%>
                <form method="post" action="updateProfileProcess.jsp">
                  <div class="row">
                    <input type="hidden" name="id" value='<%=resultSet.getString("admin_id") %>'>
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        <label>Username</label>
                        <input name="user" type="text" class="form-control" placeholder="Username" value='<%=resultSet.getString("username")%>'>
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label >Email address</label>
                        <input name="email" type="email" class="form-control" placeholder="Email" value='<%=resultSet.getString("email")%>'>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        ...
                        <input name="first" type="text" class="form-control" placeholder="First Name" value='<%=resultSet.getString("firstname")%>'>
                      </div>
                    </div>
                    <div class="col-md-5 pl-1">
                      <div class="form-group">
                        <label>Last Name</label>
                        <input name="last" class="form-control" placeholder="Last Name" value='<%=resultSet.getString("lastname")%>'>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Address</label>
                        <input name="address" type="text" class="form-control" placeholder="Home Address" value='<%=resultSet.getString("address_line")%>'>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <label>City</label>
                        <input name="city" type="text" class="form-control" placeholder="City" value='<%=resultSet.getString("city")%>'>
                      </div>
                    </div>
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        <label>Province</label>
                        <input name="province" type="text" class="form-control" placeholder="Province" value='<%=resultSet.getString("province")%>'>
                      </div>
                    </div>
                    <div class="col-md-3 pl-1">
                      <div class="form-group">
                        <label>Postal Code</label>
                        <input name="postal" type="number" class="form-control" placeholder="Postal Code" value='<%=resultSet.getString("postal_code")%>'>
                      </div>
                    </div>
                    <div class="col-md-5">
                      <div class="form-group">
                        <label>Phone Number</label>
                        <input name="phone" type="number" class="form-control" placeholder="Phone number" value='<%=resultSet.getString("phone_number")%>'>
                      </div>
                    </div>
                  </div>
                  <div class="row">
