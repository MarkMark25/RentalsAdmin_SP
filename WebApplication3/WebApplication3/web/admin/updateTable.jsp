      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Costumes</li>
          </ol>
          ...
          <div class="card mb-3">
            ...
            %>
              ...
              <td><input type="text" name="first_name" value="<%=resultSet.getString("name") %>"></td>
              <td><input type="text" name="last_name" value="<%=resultSet.getString("description") %>"></td>
              <!--<td><input type="text" name="city_name" value="<%=resultSet.getString("availability") %>"></td>-->
              <td><select name="city_name">
                  <option value="Available">Available</option>
                  <option value="Unavailable">Unavailable</option>
                </select>
              </td>
              <td><input type="text" name="email" value="<%=resultSet.getString("rental_price") %>"></td>
              <td><button type="submit" class="btn btn-warning" value="submit">Update</button></td>
            </tr>
              </form>
              <%
              }
