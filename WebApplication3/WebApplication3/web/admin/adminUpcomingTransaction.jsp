...
%>
                    ...
                    <tr>
                      ...
                      <td><a href='inProgress.jsp?d=<%=resultSet.getString("reservation_number")%>'> <button type="button" class="btn btn-default btn-xs btn-filter"><span style="color: green;" class="fas fa-user-check"></span></button></a>
