<%-- 
    Document   : adminShowServices
    Created on : Nov 29, 2018, 12:51:04 PM
    Author     : a.a
--%>
...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="adminHome.jsp">Baro Clothing Services</a>
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="adminFinishedTranLog.jsp">Transaction Log</a>
          </div>
        </li>  
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><%= session.getAttribute( "Name" ) %>'s Services</li>
          </ol>
...
try{
  ...
  String sql ="Select * from product where product_code = '"+no+"'"; 
...
%>
                      ...
                      <!--<td><input name='newPrice' type='number' value='New Price'/></td>
                      <td><input name='newAvail' type="number" step="0.01" min="0" value='Availability'/></td> -->
                      
                      <td>
                          <!--<a href='adminUpdateService2.jsp?e=<%=request.getParameter("newDesc")%>&d=<%=resultSet.getInt("product_code")%>'>Update</a>-->
                          <a href="" data-target="#updateService" data-toggle="modal">Update</a>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="logoutModalLable">Update Service</h5>
                            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">×</span>
                            </button>
                          </div>
                          <!--<div class="modal-body">Declining this account registration will delete its log from the database. Do you still wish to continue?
                          </div>-->
                          <form action="insertRegistration.jsp" method="post">
                            <div class="form-group">
                              ...
                              <div style="color: #0000e6;text-align: center;background-color: white;font-family: 'Comic Sans MS', cursive, sans-serif;font-size: large"><h6>${errorMessage1}</h6> </div>
                              <div class="form-row">
                                    <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                  ...
                                  <div class="form-label-group">
                                       <input maxlength="10" autocomplete='off' type="text" name="userName" class="form-control" required="required">
                                  </div>
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="form-row">
                                <div class="col-md-6">
                                  ...
                                  <div class="form-label-group">
                                      <input minlength="6" maxlength="16" autocomplete='off' type="password" id = "inputPassword" name="inputPassword" class="form-control" required="required">
                                  </div>
                                </div>
                                <div class="col-md-6">
                                    <label for="confirmPassword">Availability</label>
                                  <div class="form-label-group">
                                    <input minlength="6" maxlength="16" autocomplete='off' type="password" id= "confirmPassword" name="confirmPassword" class="form-control" required="required">
                                  </div>
                                </div>
                              </div>
                            </div>
