<%-- 
    Document   : adminHome
    Created on : Nov 29, 2018, 12:45:47 PM
    Author     : mark_
--%>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <%
              ...
              connection = DriverManager.getConnection(connectionUrl+database, userid, password);
              statement=connection.createStatement();
              String sql ="Select COUNT(*) from client where status='Pending'";
              resultSet = statement.executeQuery(sql);
              if (resultSet.next()){
            %>
                  <div class="mr-5"><%=resultSet.getString("COUNT(*)")%> Pending Users!</div>
            <%
              }
              connection.close();
              } catch (Exception e) {
              ...
              %>
                ...
                <a class="card-footer text-white clearfix small z-1" href="adminNewClientUser.jsp"><!-- HREF-->
            ...
            <%
              ...
              connection = DriverManager.getConnection(connectionUrl+database, userid, password);
              statement=connection.createStatement();
              String sql ="Select COUNT(*) from product where admin_id='"+session.getAttribute("adminID")+"'";
              resultSet = statement.executeQuery(sql);
              if (resultSet.next()){
            %>
                  <div class="mr-5"><%=resultSet.getString("COUNT(*)")%> Product still on-rent!</div>
            <%
              }
              connection.close();
              } catch (Exception e) {
              ...
              %>
                ...
                <a class="card-footer text-white clearfix small z-1" href="adminShowServices.jsp"><!-- HREF-->
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
            ...
            <%
              ...
              connection = DriverManager.getConnection(connectionUrl+database, userid, password);
              statement=connection.createStatement();
              String sql ="Select COUNT(*) from transaction where status='inProgress'";
              resultSet = statement.executeQuery(sql);
              if (resultSet.next()){
            %>
                  <div class="mr-5"><%=resultSet.getString("COUNT(*)")%> In Progress Transaction!</div>
            <%
              }
              connection.close();
              } catch (Exception e) {
              ...
              %>
                ...
                <a class="card-footer text-white clearfix small z-1" href="adminInprogressTransaction.jsp"><!-- HREF-->
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
            ...
            <%
              ...
              if (resultSet.next()){
            %>
                  <div class="mr-5"><%=resultSet.getString("COUNT(*)")%> Pending Transaction!</div>
            <%
              }
              connection.close();
              } catch (Exception e) {
              ...
              %>
                ...
                <a class="card-footer text-white clearfix small z-1" href="adminUpcomingTransaction.jsp">
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
