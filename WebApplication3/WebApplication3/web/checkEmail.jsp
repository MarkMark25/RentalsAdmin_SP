...
<%
    try{
        ...
        Connection con =(Connection) DriverManager.getConnection("jdbc:mysql://database.com:3306/weblove_attirerentals?" + "user=weblab&password=");
            ...
            ps.setString(1,request.getParameter("inputEmail"));
            ResultSet res = ps.executeQuery();
            if(res.first()){
                out.println("<font color=red>");
                out.print(""+request.getParameter("inputEmail")+" is already in use");
            }else{
                out.println("<font color=green>");
                out.print(""+request.getParameter("inputEmail")+" is available");
            }
        }catch (Exception e){
