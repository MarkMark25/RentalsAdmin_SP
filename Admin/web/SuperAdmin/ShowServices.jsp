...
try{
  ...
  String sql;
  if(searchVal!=null){
      sql ="Select concat(a.firstname,' ',a.lastname) as 'admin', b.description, b.rental_price, b.product_code, b.availability from product b join administrator a on a.admin_id = b.admin_id where a.role = 'admin' and -concat(a.firstname,' ',a.lastname) like '%"+searchVal+"%'";   
  }else{
      sql ="Select concat(a.firstname,' ',a.lastname) as 'admin', b.description, b.rental_price, b.product_code, b.availability from product b join administrator a on a.admin_id = b.admin_id where a.role = 'admin' ORDER BY a.firstname"; 
  }
...
%>
                      ...
                      <td>Php <%=resultSet.getString("rental_price") %></td>
