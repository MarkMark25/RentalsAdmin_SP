        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <%
              ...
              if (resultSet.next()){
            %>
                  <div class="mr-5"><%=count=resultSet.getInt(1)%> New Users!</div>
            <%
              }
              connection.close();
              } catch (Exception e) {
            ...
            <%
              ...
              if (resultSet.next()){
            %>
                  <div class="mr-5"><%=count=resultSet.getInt(1)%> Registered Users!</div>
            <%
              }
              connection.close();
              } catch (Exception e) {
            ...
            <%
              ...
              if (resultSet.next()){
            %>
                  <div class="mr-5"><%=count=resultSet.getInt(1)%> Denied Users!</div>
            <%
              }
              connection.close();
              } catch (Exception e) {
            ...
            <%
              ...
              if (resultSet.next()){
            %>
                  <div class="mr-5"><%=count=resultSet.getInt(1)%> Blocked Users!</div>
            <%
              }
              connection.close();
              } catch (Exception e) {
