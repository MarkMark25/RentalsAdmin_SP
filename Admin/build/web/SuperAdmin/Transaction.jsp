<%-- 
    ...
    Created on : Nov 29, 2018, 1:07:26 PM
    Author     : mark_
--%>
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Terminated Transaction</li>
          </ol>
            ...
            <div class="card-header">
                <nav class="navbar navbar-expand static-top">
                    ...
                    <form class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
                        <div class="input-group">
                          <input name="searchValue" type="text" class="form-control" placeholder="Enter Service Provider..." aria-label="Search" aria-describedby="basic-addon2">
                          <div class="input-group-append">
...
try{
  ...
  String sql;
  if(searchVal!=null){
      sql ="select concat(a.firstname,' ',a.lastname) as 'admin', concat(b.firstname,' ',b.lastname) as 'client', c.rental_price,c.name,d.status from transaction d join administrator a on d.admin_id = a.admin_id join client b on d.client_id = b.client_id join product c on d.product_code = c.product_code where concat(a.firstname,' ',a.lastname) like '%"+searchVal+"%'";   
  }else{
      sql ="select concat(a.firstname,' ',a.lastname) as 'admin', concat(b.firstname,' ',b.lastname) as 'client', c.rental_price,c.name,d.status from transaction d join administrator a on d.admin_id = a.admin_id join client b on d.client_id = b.client_id join product c on d.product_code = c.product_code ORDER BY a.firstname"; 
  }
  int i=0;
  resultSet = statement.executeQuery(sql);
