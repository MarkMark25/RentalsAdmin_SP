    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <form style="margin-right: 50%;" action="insertPost.jsp" method="POST" enctype="multipart/form-data">
                    <div class="card mb-3">
                        ...
                        <div class="form-group" style="margin-left: 5%; margin-right: 5%;">
                            <label for="name">Admin ID No.</label>
                            <input type="text" style="width:20%;" class="form-control" id="name" name="nameOfCostume" value="<%= session.getAttribute( "adminID" ) %>" disabled/>
                            <br>
                            <label for="name">Name of Costume:</label>
                            <input type="text"class="form-control" id="name" name="nameOfCostume" />
                            <br>
                            ...
                            <select class="btn btn-primary dropdown-toggle" name="category">
                                <option >Category of Costume</option>
                            ...
                            <br>
                            <br>
                            <input type="checkbox" name="terms" value="Terms" checked> I agree to Dacs Clothing Services <a href="url">Terms &amp; Condition</a>
                            <br>
                            <br>
                            <input type="submit" name="submit" id="singlebutton">
                        </div>
                    </div>  
                </form>
            </div>
